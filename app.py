...
#Gathered Tables to be uploaded in Mongo DB#
...
#Table creation and data insertion into postgresql
...
#Calling functions for postgre DB tables
...
#tables to be visible in UI from Mongo DB
...
#streamlit UI section for frontend#
...
#Buttons to call tables to insert data into postgres DB
if st.button("Migrate channel_details"):
    Table=tables(unique_channel)
    st.success(Table)

if st.button("Migrate playlist_details"):
    Table=tables1(unique_channel)
    st.success(Table)

if st.button("Migrate videos_details"):
    Table=tables2(unique_channel)
    st.success(Table)

if st.button("Migrate comments_details"):
...
#SQL Section with Question and Answers#
mydb=psycopg2.connect(host="localhost",
                    user="postgres",
                    password="Summer#2024",
                    database="youtube_harvesting_guvi",
